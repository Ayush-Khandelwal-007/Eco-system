      ...
      <Table className={classes.table} aria-label="customized table">
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell align="right">FEE Status at the time of Admission</StyledTableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {defaultersList.map((row,index) => (
            <StyledTableRow key={index}>
              ...
              <StyledTableCell align="right">{row.feeStatusAtAdmis===0?('Paid At the time of admission'):('Not Paid At the time of admission')}</StyledTableCell>
            </StyledTableRow>
          ))}
        </TableBody>
      </Table>
