    ...
    return (
        <div className={sidebar.sidebar}>
            <div className={sidebar.info}>
                <img src={state?.user?.imageurl} alt="Profile gic" className={sidebar.profilepic}/>
                <div className={sidebar.enroll}>{state?.user?.roll.toUpperCase()}</div>
                <div className={sidebar.name}>{state?.user?.name.toUpperCase()}</div>
                <div className={sidebar.sem}> Semester - {state?.user?.semester}{
                    state?.user?.semester===1 ? ('st'):(
                        state?.user?.semester===2 ? ('nd') :(
                            state?.user?.semester===3 ?('rd') : ('th')
                        )
                    )
                }</div>
            </div>
